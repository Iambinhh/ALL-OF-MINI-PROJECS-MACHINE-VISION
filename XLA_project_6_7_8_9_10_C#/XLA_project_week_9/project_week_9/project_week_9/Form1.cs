...
namespace project_week_8
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            List<Bitmap> XYZ = ChuyendoiRGBsangHSV(Hinhgoc);
            pictureBoxKenhX.Image = XYZ[0];
            pictureBoxKenhY.Image = XYZ[1];
            pictureBoxKenhZ.Image = XYZ[2];
            pictureBoxXYZ.Image = XYZ[3];
        ...
        public List<Bitmap> ChuyendoiRGBsangHSV(Bitmap Hinhgoc)
        {
            ...
            for (int x = 0; x < Hinhgoc.Width; x++)
                ...
                {   //Getting values
                    ...
                    double Y = 0.2126729 * R + 0.7151522 * G + 0.07217508 * B;
        ...
        private void pictureBoxKenhY_Click(object sender, EventArgs e)
        {
